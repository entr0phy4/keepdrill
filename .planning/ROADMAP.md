...
- [x] 08-01-PLAN.md — WASM ABI pin, packages, CSP wasm-compile token
- [x] 08-02-PLAN.md — Blob fetch, github corpus ingest, History label
- [x] 08-03-PLAN.md — Pure unit planner and leaves-first order

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 08-04-PLAN.md — WASM seam, click-to-plan, FilePlan in App
...
- [x] 09-01-PLAN.md — Pure slice, cover, flatten, assembleSessionFromLogs

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 09-02-PLAN.md — FileScaffold chrome + App curriculum, persist, unit restart
...
| 9. Scaffolded Trainer | v2.0 | 2/2 | In Progress|  |
